  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-smm">
          MJ Estate is the best place to find your next perfect place to live.
          <br />
          We have a wide range of properties for you to choose from.
        </div>
        <Link
          to={"/search"}
          className="text-xs sn:text-sm text-blue-800 font-bold hover:underline"
        >
          Let's get started...
        </Link>
      </div>
